...
public class TimeSpanParserTests
{
    ...
    private static IEnumerable<TestCaseData> TestCases()
    {
        ...
        yield return new TestCaseData("invalid-time", null);
        yield return new TestCaseData("50", null);
        ...
        yield return new TestCaseData("00:60:00", new TimeSpan(01, 00, 00));
        yield return new TestCaseData("00:90:00", new TimeSpan(01, 30, 00));
