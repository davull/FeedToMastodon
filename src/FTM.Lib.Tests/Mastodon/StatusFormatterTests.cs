...
public class StatusFormatterTests : TestBase
{
    ...
    {
        yield return new TestCaseData("Title", "Summary", "", "https://example.com")
            .SetName("WithTitleAndSummaryAndLink");

        yield return new TestCaseData("Title", "Summary", "", null)
            .SetName("WithTitleAndSummaryAndNoLink");

        yield return new TestCaseData("Title", "", "", "https://example.com")
            .SetName("WithTitleAndNoSummaryAndLink");

        yield return new TestCaseData("Title", "", "", null)
        ...
        yield return new TestCaseData("Title", "Summary", "#tag1 #tag2 #tag3", null)
            .SetName("WithTitleAndSummaryAndTagAndNoLink");

        yield return new TestCaseData("Title", "", "#tag1 #tag2 #tag3", "https://example.com")
            .SetName("WithTitleAndTagAndNoSummaryAndLink");

        yield return new TestCaseData("Title", "", "#tag1 #tag2 #tag3", null)
